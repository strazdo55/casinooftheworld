...
function cards(list) {
  ...
  <a href="reviews/${op.slug}.html" style="display:block;margin-top:0.5rem;font-size:0.85rem">Full review →</a>
</article>`
    )
    .join("")}</div>`;
}
...
const pages = [
  ...
  <div class="breadcrumb"><a href="index.html">Home</a> » Online Casinos</div>
  <h1 class="section-title">Best Online Casinos (2026)</h1>
  <p class="lead">Licensed operators with strong slot libraries, fair <a href="bonuses.html">bonus terms</a>, and reliable <a href="banking.html">withdrawals</a>. We cross-check game fairness standards published by <a href="${AUTHORITY.ecogra.href}" target="_blank" rel="noopener noreferrer">${AUTHORITY.ecogra.label}</a>.</p>
  ${disclosure()}
  ${compareTable(operators)}
  <p>US players should read our <a href="us-casinos.html">state-by-state casino guide</a> and latest <a href="blog/us-igaming-expansion-2026.html">iGaming expansion update</a>. Slot fans can browse <a href="blog/best-new-online-slots-2026.html">new slots for 2026</a>; live-table players should see <a href="blog/best-live-dealer-casinos-2026.html">best live dealer casinos</a>.</p>
  ${cards(operators)}
</div>${sidebar}</main>`,
  },
  {
    ...
    body: `<main class="container page-grid"><div>
  <p class="lead" style="background:#ebf8ff;padding:1rem;border-radius:8px"><strong>Primary focus: online casinos.</strong> For slots, live dealer, and casino bonuses visit our <a href="online-casinos.html">casino rankings</a> and <a href="games.html">games hub</a>.</p>
  ...
  },
  {
    file: "bonuses.html",
    body: `<main class="container page-grid"><div>
  <div class="breadcrumb"><a href="index.html">Home</a> » Casino Bonuses</div>
  <h1 class="section-title">Online Casino Bonuses &amp; Free Spins</h1>
  <p class="lead">Always read wagering requirements and expiry dates before opting in. Compare offers alongside our <a href="online-casinos.html">casino rankings</a> and <a href="blog/twenty-dollar-casino-method.html">bankroll strategy guide</a>.</p>
  ${disclosure()}
  ...
  },
  {
    file: "banking.html",
    body: `<main class="container page-grid"><div>
  <div class="breadcrumb"><a href="index.html">Home</a> » Banking</div>
  <h1 class="section-title">Banking &amp; Payout Methods</h1>
  <p class="lead">Crypto often clears fastest; debit cards are widely accepted for deposits but may not support withdrawals. See our <a href="blog/fastest-payout-online-casinos.html">fastest payout casino comparison</a>.</p>
  ${disclosure()}
  ...
  <ul>
    ...
    <li><strong>Bitcoin / crypto</strong> — popular at <a href="reviews/bovada.html">Bovada</a> and <a href="reviews/betus.html">BetUS</a> for fast cash-outs</li>
  ...
  },
  {
    file: "games.html",
    body: `<main class="container page-grid"><div>
  <div class="breadcrumb"><a href="index.html">Home</a> » Casino Games</div>
  <h1 class="section-title">Casino Games Hub</h1>
  <p class="lead">Explore game types, house edges, and where to play them legally online. Compare <a href="online-casinos.html">licensed casinos</a> before depositing.</p>
  <div class="card-grid">
    <article class="affiliate-card"><h3>Online Slots</h3><p>RNG titles, progressive jackpots, and bonus-buy features. See <a href="blog/best-new-online-slots-2026.html">best new slots for 2026</a>.</p><a href="blog/live-dealer-vs-rng-slots.html">RNG vs live guide →</a></article>
    <article class="affiliate-card"><h3>Live Dealer</h3><p>Streamed blackjack, roulette, and game shows with real hosts. Studios from providers like <a href="${AUTHORITY.evolution.href}" target="_blank" rel="noopener noreferrer">Evolution</a>.</p><a href="blog/best-live-dealer-casinos-2026.html">Top live casinos →</a></article>
    <article class="affiliate-card"><h3>Table Games</h3><p>Learn basic strategy for blackjack and baccarat.</p><a href="blog/twenty-dollar-casino-method.html">Bankroll tips →</a></article>
  </div>
</div>${sidebar}</main>`,
  },
  {
    ...
    body: `<main class="container page-grid"><div>
  <div class="breadcrumb"><a href="index.html">Home</a> » US Casinos</div>
  ...
  ${disclosure()}
  <p>As of 2026, regulated iGaming continues to expand. See our <a href="blog/us-igaming-expansion-2026.html">US iGaming expansion report</a> for legislative updates and <a href="casinos-by-country.html">international alternatives</a>.</p>
  ...
  },
  {
    ...
    body: `<main class="container page-grid"><div>
  <div class="breadcrumb"><a href="index.html">Home</a> » By Country</div>
  ...
  <ul>
    <li><strong>United States</strong> — <a href="us-casinos.html">US casino guide</a></li>
    <li><strong>Canada</strong> — provincial rules apply; check operator geo-targeting</li>
    <li><strong>United Kingdom</strong> — UKGC-licensed brands (<a href="reviews/888casino.html">888casino</a>, <a href="reviews/leovegas.html">LeoVegas</a>)</li>
  ...
  <p class="lead">Partnerships, corrections, or reader questions—send a message below (demo form). Editorial standards are described on <a href="about.html">About Us</a>.</p>
  <form data-demo-form>
  ...
  <p>Editorial standards require hands-on testing, transparent <a href="affiliate-disclosure.html">affiliate disclosures</a>, and responsible gambling messaging on every money page. We link to recognized help organizations including <a href="${AUTHORITY.ncpg.href}" target="_blank" rel="noopener noreferrer">NCPG</a> and <a href="${AUTHORITY.begambleaware.href}" target="_blank" rel="noopener noreferrer">BeGambleAware</a>.</p>
  <p>Explore our <a href="online-casinos.html">casino comparisons</a>, <a href="reviews/index.html">operator reviews</a>, and <a href="blog/index.html">casino blog</a>.</p>
</main>`,
  },
  {
  ...
  <p>Ratings are based on our review criteria published in <a href="reviews/index.html">operator reviews</a>. Commercial relationships do not guarantee placement or score. See <a href="privacy.html">Privacy Policy</a> and <a href="terms.html">Terms of Use</a>.</p>
</main>`,
  },
  {
    file: "privacy.html",
  ...
  <p>Contact: privacy@casinooftheworld.com (placeholder). Return to <a href="index.html">homepage</a> or read our <a href="affiliate-disclosure.html">affiliate disclosure</a>.</p>
</main>`,
  },
  {
    file: "terms.html",
...
for (const op of operators) {
  ...
  <div class="breadcrumb"><a href="../index.html">Home</a> » <a href="index.html">Reviews</a> » ${op.name}</div>
  <h1 class="section-title">${op.name} Review (2026)</h1>
  ${disclosure().replace(/href="affiliate/g, 'href="../affiliate')}
  <p class="lead">${op.name} targets players who want ${op.bestFor.toLowerCase()}. Welcome offer: ${op.welcomeBonus}. Compare alternatives on <a href="../online-casinos.html">best online casinos</a> and <a href="../bonuses.html">bonus guide</a>.</p>
  <h2>Pros</h2>
  ...
  <h2>Banking</h2>
  <p>Withdrawal speeds are typically quoted as <strong>${op.payout}</strong> after KYC verification. Read our <a href="../banking.html">banking guide</a> and <a href="../blog/fastest-payout-online-casinos.html">payout comparison</a>.</p>
  <p><a href="${op.cta}" class="btn btn-lime" target="_blank" rel="nofollow sponsored noopener">Visit ${op.name}</a></p>
</article>${blogSidebar(posts, 1)}</main>`,
  });
...
await writePage(
  ...
  <div class="breadcrumb"><a href="../index.html">Home</a> » Reviews</div>
  <h1 class="section-title">Operator Reviews</h1>
  <p class="lead">Deep dives into bonuses, apps, and payout performance. Start with <a href="../online-casinos.html">casino rankings</a> or browse by topic on our <a href="../blog/index.html">blog</a>.</p>
  ${cards(operators).replace(/\.\.\//g, "../")}
</main>`,
    { depth: 1 }
  )
);
